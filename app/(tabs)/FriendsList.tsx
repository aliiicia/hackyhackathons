...
const mockData = [
  { id: '1', name: 'Adrian', streak: 15, photo: require('../../assets/pfp/adrian.png'), description: 'three sum pro' },
  { id: '2', name: 'Daniel', streak: 12, photo: require('../../assets/pfp/daniel.png'), description: 'Peaked masters in tft' },
  { id: '3', name: 'Jamal', streak: 7, photo: require('../../assets/pfp/jamal.png'), description: 'Recovering valorant addict ' },
  { id: '5', name: 'Alicia', streak: 20, photo: require('../../assets/pfp/alicia.png'), description: 'I love tartare' },
];
